...
# read in functions
source_url("https://raw.githubusercontent.com/andymadrid/WGMS_New_Figures_Code/main/functions_all_LOAD_vs_MCI")
...
# read in data
pvals.data <- get_pvals_data("/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/LOAD_MCI/Outputs/Summaries/pvals.bed")
...
pchic.summary.stats.csv <- my_write_csv(pchic.summary.stats, "/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/LOAD_MCI/PCHiC-integration-counts.csv")
