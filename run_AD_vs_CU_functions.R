...
# read in data
pvals.data <- get_pvals_data("/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/LOAD_CONTROL/Outputs/Summaries/pvals.bed")
...
pchic.summary.stats.csv <- my_write_csv(pchic.summary.stats, "/media/Data/WGBS/LOAD_MCI/Results/CONTROL_MCI_LOAD/LOAD_CONTROL/PCHiC-integration-counts.csv")
